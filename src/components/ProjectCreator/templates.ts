...
export const ADVANCED_TEMPLATES: ProjectTemplate[] = [
  // Template 1: The Unabridged Narrated Audiobook
  {
    ...
    nameZh: '完整朗读有声书',
    description: 'Single narrator audiobook for ACX/Audible distribution',
    descriptionZh: '单人朗读有声书，符合 ACX/Audible 发行标准',
    icon: 'BookOpen',
    tier: 'advanced',
  ...
  // Template 2: The Multi-Voice Narrated Audiobook
  {
    ...
    nameZh: '多声优有声书',
    description: 'Full cast audiobook with distinct character voices',
    descriptionZh: '多人配音有声书，角色分明',
    icon: 'Users',
    tier: 'advanced',
    standard: 'ACX/Audible and Global Distribution Compliant',
  ...
  // Template 3: The Immersive Narrated Audiobook
  {
    ...
    nameZh: '沉浸式有声书',
    description: 'Cinematic audiobook with music, SFX and soundscapes',
    descriptionZh: '电影级有声书，配有音乐、音效和环境音',
    icon: 'Headphones',
    tier: 'advanced',
    standard: 'ACX/Audible and Global Distribution Compliant',
  ...
  // Template 4: The Solo Editorial Podcast
  {
    ...
    nameZh: '单人观点播客',
    description: 'Thought leadership, sermons, op-eds, solo storytelling',
    descriptionZh: '思想领袖内容、布道、评论文章、独白叙事',
    icon: 'Mic',
    tier: 'advanced',
  ...
  // Template 5: The Scripted Duo (Synthetic Interview)
  {
    ...
    nameZh: '脚本访谈播客',
    description: 'Synthetic interview with host and guest personas',
    descriptionZh: '模拟访谈节目，主持人与嘉宾对话',
    icon: 'MessageSquare',
    tier: 'advanced',
    standard: 'RSS/Podcast Distribution Compliant (Spotify, Apple Podcasts)',
  ...
  // Template 6: The Daily Briefing / Short-Form Audio
  {
    ...
    name: 'Daily Briefing',
    nameZh: '每日简报',
    description: 'News digests, daily briefings and bulletins',
    descriptionZh: '新闻摘要、每日简报和快讯',
    icon: 'Newspaper',
    tier: 'advanced',
    standard: 'RSS/Podcast Distribution Compliant (Spotify, Apple Podcasts)',
    ...
    mediaRequirements: 'Minimal. Consistent branded signature sound at end for auditory branding.',
  },

  // Template 7: The Professional Learning And Training Library
  {
    id: 'adv-learning-library',
    name: 'Learning & Training Library',
    nameZh: '学习培训资源库',
    description: 'Modular audio for eLearning, LMS, and educational apps',
    descriptionZh: '模块化音频，用于在线学习、LMS 和教育应用',
    icon: 'Library',
    tier: 'advanced',
  ...
  // Template 8: The Narration And Voice Over Template
  {
    ...
    nameZh: '旁白与配音',
    description: 'Voice-only masters for video, slides, and presentations',
    descriptionZh: '纯语音主轨，用于视频、幻灯片和演示',
    icon: 'Video',
    tier: 'advanced',
    standard: 'Modular / Catch-All, External Media Ready',
